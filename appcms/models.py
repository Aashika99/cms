...
class MedicineHistory(models.Model):
    ...
    medicines = models.ManyToManyField(Medicine, through='MedicineHistoryDetail')


class MedicineHistoryDetail(models.Model):
    medicine_history = models.ForeignKey(MedicineHistory, on_delete=models.CASCADE)
...
class LabReport(models.Model):
    ...
    doctor_id = models.ForeignKey(DoctorAvailability, on_delete=models.CASCADE)
    staff_id = models.ForeignKey(Staff, on_delete=models.CASCADE)
    tests = models.ForeignKey(MedicineHistory, on_delete=models.CASCADE)
